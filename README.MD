...
| `GROQ_API_KEY` | Optional | Enables LLM feature labelling via Groq (`openai/gpt-oss-120b`) |
| `OPENAI_API_KEY` | Optional | Enables LLM feature labelling via OpenAI (`gpt-5.4`) |
